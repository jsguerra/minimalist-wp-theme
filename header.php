...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$minimalist_wp_description = get_bloginfo( 'description', 'display' );
			if ( $minimalist_wp_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $minimalist_wp_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
